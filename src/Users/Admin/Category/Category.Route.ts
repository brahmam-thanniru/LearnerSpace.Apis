...
categoryRouter.get("/map", AuthController.middleWare, AuthController.authorize(Role.COMPANY, Role.ADMIN, Role.ADMIN_INTERN), (req, res) => categoryObj.GetCompanyCatogryasMap(req, res));
...
CourseCategoryRouter.get("/map/:companyId", AuthController.middleWare, AuthController.authorize(Role.COMPANY, Role.ADMIN, Role.ADMIN_INTERN), (req, res) => CourseCategoryObj.getCourseCategoryMap?.(req, res));
